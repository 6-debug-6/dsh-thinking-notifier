...
| 状态 | 悬浮窗 | 声音 |
| --- | --- | --- |
| AI 正在思考 | DeepSeek 蓝呼吸点 + `AI 正在思考…` + 计时；5 秒后自动收起为右侧 25 像素边缘状态条，悬停或点击可展开 | 无 |
...
- 思考中显示 5 秒后自动收起为右侧 25 像素边缘状态条，既保持可见又不遮挡桌面按键。
- 鼠标悬停或点击边缘状态条可手动展开；新的思考、权限请求或完成状态会自动展开。
